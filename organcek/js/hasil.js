...
function fillAnswerDetail(organId, cardEl) {
  ...
  const labels = ['Tidak Pernah', 'Kadang-Kadang', 'Sering', 'Selalu'];
  const dotColors = ['#22C55E', '#EAB308', '#F97316', '#EF4444'];
  ...
  questions.forEach((q, i) => {
    ...
    row.innerHTML = `
      ...
      <span style="
        ...
        font-weight: 600;
        font-size: 0.72rem;
        border: 1px solid ${dotColors[val]}40;
        background: ${dotColors[val]}12;
